...
X1 := 41 ; Coordenada X do canto superior esquerdo
Y1 := 164  ; Coordenada Y do canto superior esquerdo
X2 := 387  ; Coordenada X do canto inferior direito
Y2 := 456  ; Coordenada Y do canto inferior direito
